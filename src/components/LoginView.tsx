...
export const LoginView: React.FC<LoginViewProps> = ({ onLoginSuccess, onLogin }) => {
  ...
  const triggerSuccess = (userData: { name: string; role: string }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (foundUser) {
      triggerSuccess({ name: foundUser.name, role: foundUser.role });
    } else {
